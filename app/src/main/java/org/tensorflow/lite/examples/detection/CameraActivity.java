...
//        CompoundButton.OnCheckedChangeListener,
  ...
  protected TextView frameValueTextView, cropValueTextView, inferenceTimeTextView,fpsTimeTextView;
...
//                if (detector != null) {
////                    MINIMUM_CONFIDENCE_TF_OD_API = (thresh);
//                }
        MainActivity.MINIMUM_CONFIDENCE_TF_OD_API = thresh;
      }
      @Override
...
// ----------------------------------- iou SeekBar
    ...
    iou_seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener(){
      ...
      public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        float iou_thresh = (float)progress / 100.0f;
        iou_textView.setText(String.format("IoU Threshold: %.2f", iou_thresh));
        YoloV5Classifier.mNmsThresh = iou_thresh;
      }
      @Override
      public void onStopTrackingTouch(SeekBar seekBar) {
      }
    ...
    iou_seekBar.setProgress(10);//0.45
// ----------------------------------- end
    ...
    fpsTimeTextView = findViewById(R.id.fps_info);
...
//  }
  ...
  protected void showFps(String fpsTime) {
    fpsTimeTextView.setText(fpsTime);
  }
