...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private long lastProcessingTimeMsFps;
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        float fps = (float)1000 / (float)(nowTime - lastProcessingTimeMsFps);
                        lastProcessingTimeMsFps = nowTime;
                        ...
                        runOnUiThread(
                                new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        String fpsText = String.format("%.2f", fps);
                                        showFps(fpsText + "");
                                    }
                                });
                    }
